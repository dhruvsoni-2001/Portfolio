  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-[95vw] sm:max-w-fit fixed top-10 inset-x-0 mx-auto border border-white/[0.1] rounded-full bg-[#000319]/70 backdrop-blur-lg shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-2 pl-4 sm:pl-8 py-2 items-center justify-between sm:justify-center space-x-2 sm:space-x-4 overflow-x-auto overflow-y-hidden text-nowrap no-scrollbar",
          className
        )}
      >
        ...
        <button className="border text-xs sm:text-sm font-medium relative border-white/[0.2] text-white px-3 sm:px-4 py-2 rounded-full hover:bg-white/5 transition-colors">
          <span>Login</span>
